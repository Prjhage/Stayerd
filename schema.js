...
module.exports.listingSchema = Joi.object({
    listing: Joi.object({
        ...
        category: Joi.string().valid("trending", "rooms", "iconic", "mountain", "castles", "pools", "camping", "farms", "arctic", "domes", "boats", "forest", "lakefront", "beach", "urban", "countryside").required(),
